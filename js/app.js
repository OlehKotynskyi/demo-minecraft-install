(() => {
    ...
    const leaf1 = __webpack_require__.p + "demo-minecraft/img/leaf1.webp";
    const leaf2 = __webpack_require__.p + "demo-minecraft/img/leaf2.webp";
    const leaf3 = __webpack_require__.p + "demo-minecraft/img/leaf3.webp";
    const leaf4 = __webpack_require__.p + "demo-minecraft/img/leaf4.webp";
    if (window.innerWidth > 549.98) {
        document.addEventListener("DOMContentLoaded", (function() {
            ...
            window.copyText = function(element) {
                ...
                if (!textElement) {
                    console.error("Не знайдено тег <span>");
                    return;
                }
                const text = textElement.innerText;
                if (navigator.clipboard) navigator.clipboard.writeText(text).then((() => {
                    showToast("Скопійовано: " + text);
                })).catch((err => console.error("Помилка копіювання:", err))); else {
